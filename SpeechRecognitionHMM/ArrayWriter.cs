...
namespace SpeechRecognitionHMM
{
    ...
    public static class ArrayWriter
    {
        ...
        public static void PrintIntArrayToFile(int[] array, string fileName)
        {
            ...
            // write the array
            for (var i = 0; i < array.Length; i++) tw.WriteLine(array[i].ToString(numberFormat));
            tw.Flush();
            tw.Close();
        }
        ...
        public static void PrintFrameWise2DDoubleArrayToConsole(double[][] array)
        {
            for (var i = 0; i < array.Length; i++)
            {
                for (var j = 0; j < array[i].Length; j++) Console.WriteLine(array[j][i]);
                Console.WriteLine();
            }
        }
        ...
        public static void Print2DDoubleArrayToConsole(double[][] array)
        {
            for (var i = 0; i < array.Length; i++)
            {
                for (var j = 0; j < array[i].Length; j++) Console.WriteLine(array[i][j]);
                Console.WriteLine();
            }
        }
        ...
        public static void PrintStringArrayToFile(string[] array, string fileName)
        {
            ...
            // write the array
            for (var i = 0; i < array.Length; i++) tw.WriteLine(array[i]);
            tw.Flush();
            tw.Close();
        }

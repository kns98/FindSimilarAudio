...
namespace math.transform.jwave.blocks
{
    ...
    public class BlockFull : Block
    {
        ...
        protected internal BlockFull(int offSetRow, int offSetCol, int noOfRows, int noOfCols) : base(offSetRow,
            offSetCol, noOfRows, noOfCols)
        {
        ...
        public override void allocateMemory()
        {
            ...
            _matrix = MathUtils.CreateJaggedArray<double[][]>(_noOfRows, _noOfCols);

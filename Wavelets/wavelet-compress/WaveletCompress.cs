namespace Wavelets.Compress
{
    ...
    public static class WaveletCompress
    {
        ...
        /// <param name="lastHeight">return last height processed</param>
        /// <param name="lastWidth">return last width processed</param>
        public static void Compress2D(double[][] data_input, int level, int threshold, out int lastHeight,
            out int lastWidth, bool doCompression = true)
        {
        ...
        public static void Compress3D(double[][][] data_input, int level, int threshold)
        {
            ...
            var ex_length = data_input[0][0].Length;
            var ex_width = data_input[0].Length;
            var ex_height = data_input.Length;

            var temp_ex_length = ex_length;
            var temp_ex_width = ex_width;
            var temp_ex_height = ex_height;

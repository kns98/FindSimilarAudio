...
namespace Soundfingerprinting.Fingerprinting.Configuration
{
    public class FullFrequencyFingerprintingConfiguration : IFingerprintingConfiguration
    {
        public FullFrequencyFingerprintingConfiguration(bool useRandomStride = false)
        {
            ...
            //WindowSize = 8192;
            WindowSize =
                4096; // due to using this on many small samples, we need to reduce the window and overlap sizes
            ...
            if (useRandomStride) // 0,046 sec is 2028 / 44100	or 	1472/32000
            ...
            else // 0,928 sec is	5115 / 5512 or 40924 / 44100	or	29695/32000
